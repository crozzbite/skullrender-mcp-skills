...
/**
 * Run the MCP server. skillsPath must be passed explicitly (from CLI args or env)
 * so it works regardless of process.cwd() or whether the host injects env.
 */
export async function runMcpServer(skillsPath: string) {
